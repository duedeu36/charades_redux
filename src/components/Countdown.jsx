  ...
  render() {
    return (
      <div style={{ marginRight: 5 }}>
        <button className="btn btn-success" onClick={this.props.startCountDown}>
          Start
        </button>
      </div>
    );
  ...
  render() {
    return (
      <div style={{ marginRight: 5, marginLeft: 30 }}>
        <button className="btn btn-danger" onClick={this.props.stopCountDown}>
          Stop
        </button>
      </div>
    );
...
//   addCountdown = event => {
//     this.setState({
//       newCountdown: event.target.value
//     });
//   };
...
//   componentDidMount() {
//     setInterval(() => this.getTime(this.state.newCountdown), 1000);
//   }
